...
Because we want to start without worrying about installing R and RStudio, I prepared a geting-started document. Please follow the process below and see if your RStudio and R are installed correctly before Wednesday (3 June). If you have issues, please let me know. 
...
![alt text](EmptyProject.png)

Then, select a new directory:

![alt text](NewDirectory.png)

Enter an appropriate directory name:

![alt text](NewDirectoryName.png)
...
![alt text](GlobalOptions.png)

Once this is setup, please download the test file I created in the Google drive (https://drive.google.com/a/noaa.gov/folderview?id=0BzryQfL97RxZfm5jd2pBc3B1OTFTbFRnTzdadnk4U2Z4UmpwQWo3TVBidUhIWmd2MHlBV0k&usp=sharing) called "turtle_R_Workshop.R". Place the file into the newly created directory, in my case "C:/Users/t_e/Documents/R/Turtle_R_Workshop" and open it in RStudio then "source" it:

![alt text](FirstSourceExample.png)
...
There are hundreds of "packages" that can be added to R to do specific analyses. All of those can be found at the CRAN website (http://cran.r-project.org/). Finding which package to use is a bit of art. You need to communicate with others in your field or search the Internet.
